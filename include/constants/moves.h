...
enum __attribute__((packed)) Move
{
    ...
    MOVE_DARK_MAGIC_ATTACK = 848,
    MOVE_WHITE_LIGHTNING = 849,
    MOVE_SKYSCRAPER = 850,
    MOVE_OBLITERATE = 851,
    MOVE_DARK_BURNING_ATTACK = 852,
    MOVE_BURST_STREAM_OF_DESTRUCTION = 853,
    MOVE_DRAGON_SWORD = 854,
    MOVE_SKYDIVE_SCORCHER = 855,
    MOVE_FLAME_SWORD = 856,
    MOVE_CHAOS_BLADE = 857,
    MOVE_SPIRAL_SPEAR = 858,
    MOVE_THUNDER_SWORD = 859,
    MOVE_INFERNO_BLAST = 860,
    MOVE_AXE_SLAM = 861,
    MOVE_METAL_THRUST = 862,
    MOVE_CYBER_SLASH = 863,
    MOVE_TRIPLE_SLICE = 864,
    MOVE_CYBER_ENERGY_SHOCK = 865,
    MOVE_CELTIC_BLADE = 866,
    MOVE_DARK_LIGHT = 867,
    MOVE_VENGEANCE = 868,
    MOVE_MAGNET_SWORD = 869,
    MOVE_FIST_OF_FATE = 870,
    MOVE_THUNDER_FORCE = 871,
    MOVE_PHOENIX_FORM = 872,
    MOVE_DEFENSE_MODE = 873,
    MOVE_BOMBARDMENT = 874,
    MOVE_DESTINY_BOARD = 875,
    MOVE_BUBBLE_BLASTER = 876,
    MOVE_SCRAP_FIST = 877,
    MOVE_TOXIC_BREATH = 878,
    MOVE_SILENT_BURN = 879,
    MOVE_NEUTRON_BLAST = 880,
    MOVE_NEGATE = 881,
    MOVE_SHRINK = 882,
    MOVE_MECHANIZED_MELEE = 883,
    MOVE_CELESTIAL_SWORD = 884,
    MOVE_SPARK_BLASTER = 885,
    MOVE_MYSTICAL_SPACE_TYPHOON = 886,
    MOVE_PARASITE_PARACIDE = 887,
    MOVE_SWORDS_OF_REVEALING_LIGHT = 888,
    MOVE_STRIDENT_BLAZE = 889,
    MOVE_METALMORPH = 890,
    MOVE_MIRROR_WALL = 891,
    MOVE_RING_OF_DESTRUCTION = 892,
    MOVE_CHAOS_SCEPTER_BLAST = 893,
    MOVE_SILENT_SLASH = 894,
    MOVE_POINT2POINT = 895,
    MOVE_NAP_TIME = 896,
    MOVE_OJAMA_DELTA_HURRICANE = 897,
    MOVE_TRANSCENDENT_WINGS = 898,
    MOVE_PARALYZING_PELLET_BARRAGE = 899,
    MOVE_CLOCK_PRISON = 900,
    MOVE_ULTIMATE_POUND = 901,
    MOVE_RAINBOW_REFRACTION = 902,
    MOVE_NEOS_FORCE = 903,
    MOVE_MEGAMORPH = 904,

    MOVES_COUNT_POKEDUEL,
    MOVES_COUNT = MOVES_COUNT_POKEDUEL,
